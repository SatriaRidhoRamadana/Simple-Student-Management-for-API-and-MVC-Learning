...
<head>
    ...
    <title>Tambah Mahasiswa - Belajar MVC</title>
    <style>
        ...
        <div class="content">
            ...
            <div class="info-box" style="margin-top: 30px;">
                ...
                <ul style="margin-left: 20px; margin-top: 10px;">
                    <li><strong>Model:</strong> Student_model menangani penyimpanan data ke database</li>
                    <li><strong>Controller:</strong> Metode store() menerima input form dan memanggil model</li>
                    <li><strong>View:</strong> File ini menampilkan form kepada user</li>
                </ul>
            </div>
        </div>
    </div>
